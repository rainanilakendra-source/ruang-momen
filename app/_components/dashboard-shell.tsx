  ...
  return (
    <header className="flex flex-col gap-6 border-b border-[#F5F0E7]/[.08] pb-7 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex items-center gap-3 self-start sm:self-auto">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-[#F5F0E7]/10 bg-[#0A1D30] py-1.5 pr-3 pl-1.5"><span className="grid h-9 w-9 place-items-center rounded-lg bg-[#D6B56F]/12 font-serif text-sm italic text-[#D6B56F]">PR</span><span className="text-sm font-semibold">{userName}</span></div>
      </div>
    </header>
  );
}
