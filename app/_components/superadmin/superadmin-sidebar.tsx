...
const items: { labelKey: string; href: string; icon: AppIconName }[] = [
  { labelKey: "superadmin.dashboard", href: "/superadmin", icon: "home" },
  { labelKey: "superadmin.users", href: "/superadmin?view=users", icon: "account" },
  { labelKey: "superadmin.plans", href: "/superadmin/plans", icon: "spaces" },
  { labelKey: "superadmin.features", href: "/superadmin/features", icon: "lock" },
  { labelKey: "superadmin.payments", href: "/superadmin/payments", icon: "billing" },
  { labelKey: "superadmin.orders", href: "/admin/orders", icon: "billing" },
  { labelKey: "superadmin.settings", href: "/superadmin?view=settings", icon: "calendar" },
  { labelKey: "superadmin.logs", href: "/superadmin?view=logs", icon: "album" },
];
