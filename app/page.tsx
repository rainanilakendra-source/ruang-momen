...
const langkah = [
  { id: "alur-buat-ruang", nomor: "01", ikon: "ruang", judul: "Buat ruangmu", deskripsi: "Beri nama acara dan siapkan ruang dalam beberapa langkah." },
  { id: "alur-bagikan-qr", nomor: "02", ikon: "qr", judul: "Bagikan QR", deskripsi: "Letakkan QR di meja, undangan, atau area acara. Tamu cukup scan dari HP." },
  { id: "alur-kumpulkan-momen", nomor: "03", ikon: "album", judul: "Kumpulkan momennya", deskripsi: "Setiap foto dari tamu langsung tersimpan dalam satu album bersama." },
];
    ...
    <main className="min-h-screen overflow-hidden bg-[#071727] pb-[calc(6rem+env(safe-area-inset-bottom))] text-[#F5F0E7] lg:pb-0">
      ...
      <nav className="fixed right-0 bottom-0 left-0 z-50 px-3 pb-[calc(.75rem+env(safe-area-inset-bottom))] lg:hidden" aria-label="Navigasi bawah">
        <div className="mx-auto grid h-[68px] w-full max-w-[400px] grid-cols-5 items-center rounded-[24px] border border-[#F5F0E7]/10 bg-[rgba(10,29,48,0.92)] px-1 shadow-[0_16px_42px_rgba(0,0,0,.34)] backdrop-blur-[18px]">
          <a href="#beranda" className="flex min-h-12 flex-col items-center justify-center gap-1 text-[#F5F0E7]" aria-label="Beranda"><IkonNavigasi nama="beranda" /><span className="text-[9px] font-medium"><T k="navigation.home" /></span></a>
          <a href="#cara-kerja" className="flex min-h-12 flex-col items-center justify-center gap-1 text-[#AEB8BE] transition-colors hover:text-[#F5F0E7]" aria-label="Alur"><IkonNavigasi nama="cara" /><span className="text-[9px] font-medium"><T k="navigation.flow" /></span></a>
          <a href="/daftar" className="group -translate-y-2.5 flex min-h-16 flex-col items-center justify-center gap-1" aria-label="Buat Ruang"><span className="grid h-[52px] w-[52px] place-items-center rounded-[18px] border border-[#F5F0E7]/10 bg-[linear-gradient(145deg,#F1DDA7_0%,#D6B56F_52%,#A98242_100%)] text-[#071727] shadow-[inset_0_1px_0_rgba(245,240,231,.3),0_9px_22px_rgba(0,0,0,.24)] transition-transform group-active:scale-95"><BrandIcon className="h-9 w-9 drop-shadow-[0_2px_5px_rgba(7,23,39,.3)]" /></span><span className="text-[9px] font-semibold text-[#F5F0E7]"><T k="navigation.createRoom" /></span></a>
          <a href="#contoh-album" className="flex min-h-12 flex-col items-center justify-center gap-1 text-[#AEB8BE] transition-colors hover:text-[#F5F0E7]" aria-label="Inspirasi"><IkonNavigasi nama="contoh" /><span className="text-[9px] font-medium"><T k="navigation.inspiration" /></span></a>
          <a href="#faq" className="flex min-h-12 flex-col items-center justify-center gap-1 text-[#AEB8BE] transition-colors hover:text-[#F5F0E7]" aria-label="Bantuan"><IkonNavigasi nama="faq" /><span className="text-[9px] font-medium"><T k="common.help" /></span></a>
        </div>
      </nav>
    </main>
  );
